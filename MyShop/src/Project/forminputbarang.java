...
public class forminputbarang extends javax.swing.JFrame {
   ...
   public void delete(){
        try {
            ...
            String sqla = "DELETE FROM tbl_barang WHERE jumlah_barang = 0";
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 180, -1, 30));

        jLabel6.setFont(new java.awt.Font("Roboto", 0, 14)); // NOI18N
        jLabel6.setForeground(new java.awt.Color(0, 102, 102));
        jLabel6.setText("Harga Beli");
        jPanel1.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 230, -1, 20));

        thargajual.setFont(new java.awt.Font("Roboto", 0, 11)); // NOI18N
        thargajual.setForeground(new java.awt.Color(0, 153, 153));
        ...
        tabelinput.setFont(new java.awt.Font("Roboto", 0, 11)); // NOI18N
        ...
        tcari.setFont(new java.awt.Font("Roboto", 0, 11)); // NOI18N
        tcari.setForeground(new java.awt.Color(0, 153, 153));
